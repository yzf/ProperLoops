...
${OBJECTDIR}/src/global.o: src/global.cc 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/global.o src/global.cc

${OBJECTDIR}/src/graph.o: src/graph.cc 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/graph.o src/graph.cc

${OBJECTDIR}/src/hash.o: src/hash.cc 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/hash.o src/hash.cc
...
${OBJECTDIR}/src/rule.o: src/rule.cc 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/rule.o src/rule.cc
...
${OBJECTDIR}/src/vocabulary.o: src/vocabulary.cc 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/vocabulary.o src/vocabulary.cc
